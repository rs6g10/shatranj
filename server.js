var path         = require('path')
  ...
  , GameStore    = require('./lib/ShatranjStore');
...
var cookieParser = express.cookieParser('Jhoompa Lahiri')
  , sessionStore = new express.session.MemoryStore();

// Settings
app.set('port', process.env.PORT || 8085);
app.set('views', __dirname + '/views');
app.set('view engine', 'jade'); //Jade is so fucking strange, i hate it...Get your shit together Rahul
...
server.listen(app.get('port'), function(){
  console.log('Shatranj is listening on port ' + app.get('port'));
});
